...
export default function StudentClasses() {
  ...
  const loadData = async () => {
    try {
      ...
      // Get classes with attendance statistics
      const response = await api.getChildAttendanceClasses(studentId);
      if (response.success) {
  ...
  const handleClassClick = async (classItem) => {
    ...
    try {
      const response = await api.getChildClassAttendance(studentId, classItem.subject_enroll_id);
      if (response.success) {
    ...
    return (
      <DashboardLayout>
        <div style={{ 
          ...
          <p style={{ color: '#6b7280', fontSize: '1.1rem' }}>Loading attendance data...</p>
        </div>
      </DashboardLayout>
    );
  }
          ...
          <>
            ...
            <div style={{ marginBottom: '32px' }}>
              <h1 style={{ 
                ...
                {studentInfo ? `${studentInfo.std_eng_name}'s Attendance` : 'Attendance'}
              </h1>
              <p style={{ 
                margin: 0, 
                fontSize: '0.95rem', 
            ...
            {loadingRecords ? (
              ...
              <div style={{
                ...
                <p style={{ 
                  ...
                  The teacher hasn't recorded any attendance for this class yet.
                </p>
              </div>
            ) : (
              <div style={{
